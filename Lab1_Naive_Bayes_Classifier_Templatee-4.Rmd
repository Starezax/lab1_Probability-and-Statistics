...
ham_count <- class_dist["ham"] #normal words
spam_count <- class_dist["spam"] #spam
total_count <- nrow(train)
ham_percent <- round((ham_count / total_messages) * 100, 1)
spam_percent <- round((spam_count / total_messages) * 100, 1)


cat("Distributions with percentages:", "\n")
